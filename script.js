  ...
  },
  {
    ...
    subtitle: "جامعة الابتكار",
            committees: [
      {
        ...
        points: [
          "استلام أكثر من ٥٠٠ قطعة تبرعات وتوزيعها في قافلة أثر ٣ وتوزيعات فردية.",
          "إقامة معارض ملابس في: كامب المنيا، قافلة أثر ٤، ومعرض كساء المدارس بالجامعة."
        ]
      },
      {
        name: "لجنة الإطعام",
        points: [
          "إقامة مائدة الطعام الرمضانية طوال ٣٠ يوماً بعدد ١٨,٥٠٠ وجبة.",
          "تعبئة ٥٠٠ كرتونة مواد غذائية أساسية، وتعبئة ٣٨٠ شنطة رمضانية.",
          "توزيع ٤٠٠ شنطة في كامب أسوان والمنيا، و٦٠٠ شنطة في قوافل أثر الأربعة."
        ]
      },
      {
      ...
      },
      {
        name: "لجنة الميديا",
        points: [
          "تغطية احتفال روح واحدة، وجميع قوافل السنة أثر (أثر ١، أثر ٢، أثر ٣، أثر ٤).",
          "تغطية زيارات الأيتام والمسنين والاستكشافات والتوزيعات الفردية.",
          "تغطية فعاليات لجنة الإطعام، كامب المنيا وأسوان، ودورة الإسعافات والتبرع بالدم."
        ]
      },
      {
        name: "لجنة الاتصالات",
        points: [
          "قامت بالتغطية والتنسيق الفعال لكافة الإيفنتات والفعاليات القائمة بإدارة التطوع."
        ]
      },
      {
        name: "لجنة المشتريات",
        points: [
          "المشاركة وتوفير وتجهيز المشتريات لكافة الإيفنتات والفعاليات القائمة بإدارة التطوع."
        ]
      },
      {
        name: "لجنة HR (الموارد البشرية)",
        points: [
          "تنظيم وإدارة شؤون المتطوعين، المقابلات الشخصية، التقييم، وبناء وتطوير مهارات الفريق."
        ]
      }
    ]
  },
