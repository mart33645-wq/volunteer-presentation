...
const slides = [
  {
    ...
    subtitle: "رؤية طموحة وأثر مستدام في خدمة المجتمع",
    description:
      "تعد إدارة التطوع بجامعة الابتكار صرحاً رائداً يهدف إلى غرس قيم العطاء والمسؤولية المجتمعية لدى الطلاب، وتوجيه طاقاتهم نحو خدمة المجتمع والتنمية المستدامة من خلال مبادرات نوعية ومشاريع ميدانية وتنموية متكاملة.",
    images: [logo]
  },
  {
    type: "about",
    ...
    committees: [
      {
        name: "لجنة الاستكشاف",
        points: [
          "تم عمل استكشاف لـ 85 حالة ما بين حالات تم استكشافها من خلال القوافل وحالات فردية."
        ]
      },
      {
        name: "لجنة القوافل العينية",
        points: [
          "تم مساعدة 240 أسرة عبر كامب أسوان وكامب المنيا، وقوافل أثر (1 ههيا، 2 الإسماعيلية، 3 الصف، 4 الإسماعيلية).",
          "حالات فردية في العاشر وبلبيس (عدد 15 حالة فردية).",
          "وتم مساعدة 8 عرايس في السنة."
        ]
      },
      {
        name: "لجنة الأسقف",
      ...
      },
      {
        ...
        points: [
          "المساعدة في الكشف على 70 حالة من أفراد الجامعة.",
          "التبرع بالدم بعدد 50 كيس دم.",
          "علاج شهري لأكثر من 10 أفراد بإجمالي مساعدات وصل لـ 130 فرد.",
          "تم منح 80 شهادة إسعافات أولية."
        ]
      },
      {
        name: "لجنة زيارات الأيتام والمسنين",
        points: [
          "6 زيارات دار أيتام منهم احتفال بيوم اليتيم.",
          "2 زيارة دار مسنات.",
          "حفلة أطفال وزيارة مسنات في قافلة أثر 4."
        ]
      }
    ]
  },
    ...
    committees: [
      {
        ...
        points: [
          "تم استلام أكثر من 500 قطعة.",
          "تم توزيع الملابس على الأسر في قافلة أثر 3 وتوزيعات فردية.",
          "تم عمل معرض ملابس في كامب المنيا.",
          "تم إقامة معرض ملابس في قافلة أثر 4.",
          "تم إقامة معرض ملابس وكساء مدارس في الجامعة."
        ]
      },
      {
        name: "لجنة الإطعام",
        points: [
          "مائدة الطعام 30 يوم بعدد (18,500) وجبة.",
          "تم تعبئة 500 كرتونة.",
          "تم تعبئة شنط لقوافل رمضان بعدد (280 شنطة) + تعبئة عدد (100 شنطة) أخرى.",
          "تم توزيع في كامب أسوان والمنيا بعدد (400 شنطة).",
          "تم توزيع في الـ 4 قوافل أثر بعدد (600 شنطة)."
        ]
      },
      {
      ...
      },
      {
        ...
        points: [
          ...
          "تغطية جميع قوافل السنة أثر (1 / 2 / 3 / 4).",
