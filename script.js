  ...
  },
  {
    ...
    subtitle: "جامعة الابتكار",
                committees: [
      {
        ...
        points: [
          "فرز وتوزيع ٥٠٠ قطعة ملابس بقافلة أثر ٣ وتوزيعات فردية.",
          "إقامة معارض كساء بكامب المنيا، قافلة أثر ٤، ومعرض المدارس بالجامعة."
        ]
      },
      {
        name: "لجنة الإطعام",
        points: [
          "تقديم ١٨,٥٠٠ وجبة إفطار طوال شهر رمضان المبارك.",
          "تعبئة وتوزيع ٥٠٠ كرتونة غذائية و١,٣٨٠ شنطة رمضانية وقوافل."
        ]
      },
      {
        name: "لجنة إعمار المساجد",
        points: [
          "صيانة شاملة للمرافق والكهرباء والسباكة وفرش المساجد والمصاحف وأجهزة التهوية."
        ]
      },
      {
        name: "لجنة الميديا",
        points: [
          "تغطية احتفال روح واحدة، وجميع قوافل أثر الأربعة السنوية.",
          "تغطية زيارات الأيتام، الاستكشاف، الإطعام، وحملات التبرع بالدم والإسعافات."
        ]
      },
      {
        name: "لجنة الاتصالات",
        points: [
          "التنسيق الإعلامي والمتابعة الفعالة لكافة فعاليات وإيفنتات إدارة التطوع."
        ]
      },
      {
        name: "لجنة المشتريات",
        points: [
          "تأمين وتجهيز وتوفير كافة المشتريات والمستلزمات لجميع أنشطة الإدارة."
        ]
      },
      {
        name: "لجنة الموارد البشرية",
        points: [
          "تنظيم شؤون المتطوعين، المقابلات الشخصية، التقييم، وبناء مهارات الفريق."
        ]
      }
    ]
  },
